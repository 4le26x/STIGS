 <#
.SYNOPSIS
Logs all PowerShell commands and outputs for auditing and forensic investigations.
.NOTES
...
# Enable PowerShell Transcription by setting EnableTranscripting to 1
Try {
    Set-ItemProperty -Path $regPath -Name $regName -Value $regValue -Type DWord
    Write-Host "Successfully enabled PowerShell Transcription (`EnableTranscripting` = 1)." -ForegroundColor Green
} Catch {
